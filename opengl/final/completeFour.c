...
// rewrite the translatePoint function to make the point the first point px be at the top of the screen and the
...
//     }
// }
// // rewrite the scalePoint function to make the point begin from the middle of the screen on all screen sizes
